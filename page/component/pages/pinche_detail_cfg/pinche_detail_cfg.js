...
Page({
  data: {
    ...
    shareImageHeight: 0,
    paymoney: '',
    from_place_longitude: 116.48834,
    from_place_latitude: 39.91692,
  ...
  onShareAppMessage: function (event) {
    return {
      title: "【车找货】" + this.data.from_place + "→" + this.data.to_place,//this.data.shareTitle,
      desc: this.data.shareDesc,
      path: 'page/component/pages/pinche_detail_cfg/pinche_detail_cfg?id=' + this.data.editId
    }
  }
})
