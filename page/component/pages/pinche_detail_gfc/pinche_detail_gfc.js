...
Page({
  ...
  onShareAppMessage: function (event) {
    return {
      title: "【货找车】" + this.data.from_place + "→" + this.data.to_place,//this.data.shareTitle,
      desc: this.data.shareDesc,
      path: 'page/component/pages/pinche_detail_gfc/pinche_detail_gfc?id=' + this.data.editId
    }
  }
})
